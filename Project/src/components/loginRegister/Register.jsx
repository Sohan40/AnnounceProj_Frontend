      ...
      <div className="register d-flex justify-content-center align-items-center">
        <form action="" className="row" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="col-lg-6">
            ...
            <div className="mb-3">
              ...
              <div className="w-100 m-0 p-0 input-group">
                ...
                />
                <span style={{ height: "38px" }} className="input-group-text">
                  {type === "text" ? (
                    <svg
                      onClick={() => {
                        setType("password");
          ...
          <div className="mb-3 text-center mt-3">
            <button type="submit" className="btn btn-primary shadow-none w-75">
              Submit
            </button>
          </div>
          ...
          <p
            style={{
              backgroundColor: "rgba(255, 110,110,0.553)",
            }}
          >
            {message}
          </p>
